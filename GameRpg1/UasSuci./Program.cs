...
namespace RPGGame
{
    ...
    // Visual Utilities for adding color and banners
    static class GameUI
    {
...
{GetInventoryDisplay(player.Inventory)}
    ...
    // Treasure Box Class with More Dynamic Rarity and Loot
    public class TreasureBox
    {
        ...
        private void GenerateReward(Player player)
        {
            ...
            {
                // Rare item or bonus EXP
                player.AddItem(new ManaPotion()); // Can be replaced with other rare items
                GameUI.PrintMessage("You have obtained a rare Mana Potion!", ConsoleColor.Magenta);
            }
        }
    }

    // Encounter Class with Enhanced Battle System
